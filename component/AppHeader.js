class AppHeader extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
<header class="fixed top-0 w-full bg-[#522864] h-20 z-20" id="header">
<img src="/img/me.webp" class="absolute top-1 left-4 h-18" alt="Image de profil"/>
<nav class="flex flex-col md:flex-row bg-[#522864] items-center p-6 justify-center md:space-x-4 hidden md:flex" id="nav">
   <a class="hover:underline" href="#home">Accueil</a>
   <a class="hover:underline" href="#about">À propos de moi</a>
   <a class="hover:underline" href="#skills">Mes compétences</a>   
