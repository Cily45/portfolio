class AppSkills extends HTMLElement {
    connectedCallback() {
        ...
        <div class="space-y-4">
            <div class="space-y-2">
                <p>Stack de programmation</p>
                <div class="md:h-35 flex flex-row flex-wrap justify-center px-4 min-w-full m-auto md:overflow-x-auto md:scrollbar-none ">
                    ${this.getIcons(this.iconsLanguages)}
                </div>
            </div>
            <div>
                <p>Frameworks</p>
                <div class="md:h-35 flex flex-row flex-wrap justify-center px-4  min-w-full m-auto space-x-4 md:overflow-x-auto md:scrollbar-none ">
    ...
    iconTemplate(icon) {
        return `
    <div class="w-25 h-30 bg-white border-2 border-purple-900 shadow-lg m-2 shadow-purple-500 p-2 rounded-xl shrink-0 snap-center capitalize text-center">
        ${icon.svg}
